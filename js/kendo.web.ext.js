            ...
            that.bind("activate", function () {
                setTimeout(function () {
                    that.wrapper.css("display", "")
                        ...
                        .css("transform", "");
                }, that.options.animation.duration);
            });
        },
    ...
    kendo.ui.ExtAlertDialog = {
        show: function (options) {
            return new $.Deferred(function (deferred) {
                ...
                $(document.body).append(kendo.format("<div id='extAlertDialog' style='position:relative;'><div style='position:absolute;left:10px;top:10px;' class='k-ext-information'></div><div style='display:inline-block;margin-left:45px;'>{0}</div></div>", options.message));
                $("#extAlertDialog").kendoExtDialog(options);
                $("#extAlertDialog").parent().find("div.k-window-titlebar div.k-window-actions").empty();
                $("#extAlertDialog").data("kendoExtDialog").center().open();
            });
        }
    };
    ...
    kendo.ui.ExtOkCancelDialog = {
        show: function (options) {
            return new $.Deferred(function (deferred) {
                ...
                $(document.body).append(kendo.format("<div id='extOkCancelDialog' style='position:relative;'><div style='position:absolute;left:10px;top:10px;' class='k-ext-information'></div><div style='display:inline-block;margin-left:45px;'>{0}</div></div>", options.message));
    ...
    kendo.ui.ExtYesNoDialog = {
        show: function (options) {
            return new $.Deferred(function (deferred) {
                ...
                $(document.body).append(kendo.format("<div id='extYesNoDialog' style='position:relative;'><div style='position:absolute;left:10px;top:10px;' class='k-ext-information'></div><div style='display:inline-block;margin-left:45px;'>{0}</div></div>", options.message));
